    ...
    <section class="w3l-breadcrumb1">
      <div class="container">
        <ul class="breadcrumbs1-custom-path">
		  ...
		  <li class="active"><span class="fa fa-chevron-right mx-2" aria-hidden="true"></span>Plates</li>
        </ul>
      </div>
    </section>
  </div>
  ...
  <section class="w3l-index py-5">
        <div class="container py-md-4 py-3">
            <div class="title-heading-w3 text-center mx-auto">
                <h3 class="title-main">Plates</h3>
                
            </div>
            <div class="row bottom_grids mt-5 pt-lg-3">
					<?php 
					$sql=mysqli_query($conn,"select * from product where pname='Plates'" );
