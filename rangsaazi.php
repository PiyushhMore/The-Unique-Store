...
<body>
 ...
 <?php include 'nav.php';?>
  ...
  <div class="inner-banner">
    <section class="w3l-breadcrumb165">
      <div class="container">
        <ul class="breadcrumbs165-custom-path">
         <li><a href="index.php">Home</a></li>
		  <li class="active"><span class="fa fa-chevron-right mx-2" aria-hidden="true"></span>RangSaazi</li>
        </ul>
      </div>
    </section>
  </div>
  ...
  <section class="w3l-index py-5">
        <div class="container py-md-4 py-3">
            <div class="title-heading-w3 text-center mx-auto">
                <h3 class="title-main">Rang Saazi</h3>
                
            </div>
            <div class="row bottom_grids mt-5 pt-lg-3">
					<?php 
					
					$sql=mysqli_query($conn,"select * from product as p LEFT JOIN subcategory  as s ON p.spname=s.sid where s.sid='16'");
