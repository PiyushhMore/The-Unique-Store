...
<body>
 ...
 <?php include 'nav.php';?>
  ...
  <div class="inner-banner">
    <section class="w3l-breadcrumb12">
      <div class="container">
        <ul class="breadcrumbs12-custom-path">
  ...
  <section class="w3l-index py-5">
        <div class="container py-md-4 py-3">
            <div class="title-heading-w3 text-center mx-auto">
                <h3 class="title-main">Trays </h3>
                <!--<p class="mt-4 sub-title"> Nulla mollis dapibus nunc, ut rhoncus
                    turpis sodales quis. Integer sit amet mattis quam.</p>-->
            </div>
            <div class="row bottom_grids mt-5 pt-lg-3">
					<?php 
					$sql=mysqli_query($conn,"select * from product as p LEFT JOIN category as c ON p.cpname=c.cid where c.cid='2'" );
