...
if( isset($_POST['login'])  ) {
 ...
 if ($conn->connect_error) {
        ...
        $ret=mysqli_query( $conn, "SELECT * FROM manager WHERE mname='$name' and Password='$password'") or die("Could not execute query: " .mysqli_error($conn));
...
<head>
  ...
  <title>PRATHAMESH ENTERPRISES | LOGIN</title>
    ...
    <div class="card-body login-card-body">
      ...
      <form action="" method="post">
        <div class="input-group mb-3">
          <input type="text" class="form-control a" name="name" placeholder="Email">
