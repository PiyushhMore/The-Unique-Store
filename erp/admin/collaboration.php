              ...
              <div class="card-body cr">
                <table id="example6" class="table table-bordered table-hover">
                  ...
                  <tr>
					...
					<th>Mobile-no</th>
					<th>Gst</th>
					<th>Why do you want to Collaboration with us?</th>
				  ...
				  $i=1;
				  $results1 = mysqli_query($conn, "select * from collaboration1");
                  ...
                  <tr>
					  ...
					  <td><?php echo $row1['prod_library'];?></td>
					  <td><?php echo $row1['price_bracket'];?></td>
					  <td><?php echo $row1['website'];?></td>
					  <td><?php echo $row1['email'];?></td>
					  <td><?php echo $row1['mobile_no'];?></td>
					  <td><?php echo $row1['gst'];?></td>
					  <td><?php echo $row1['collaboration'];?></td>
